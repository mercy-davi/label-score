...
public class ReevaluateAspect {
    ...
    @AfterReturning(pointcut = "execution(public * com.example.labelscore.service.LabelAndFlowAssistService.add(..))" +
            "|| execution(public * com.example.labelscore.service.LabelAndFlowAssistService.update(..))", returning = "retData")
