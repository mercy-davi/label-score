...
import com.example.score.bean.MiscItemBean;
import com.example.score.bean.MiscMetaBean;
...
import com.example.score.core.SumByWeightScoreRule;
import com.example.score.core.ValueScoreStrategy;
import com.example.score.core.ValueSourceExp;
import com.example.score.dao.ScoreCardModelDao;
import com.example.score.dao.ScoreRuleInstanceDao;
import com.example.score.entity.AfterProjApply;
import com.example.score.entity.ProjApply;
import com.example.score.service.InputInCompleteException;
...
import com.example.score.service.handler.ConditionalTagHandler;
import com.example.score.service.handler.ConditionalTagIsSuitHandler;
import com.example.score.service.handler.ConditionalTagWeightHandler;
import com.example.score.util.RequestUtil;
import com.example.score.util.ScoreCommonUtil;
...
import static com.example.score.bean.HierarchyRecord.flat;
import static com.example.score.core.ScoreRuleType.SumByWeight;
import static com.example.score.core.ValueScoreStrategy.CURRENT_USER;
import static com.example.score.core.ValueScoreStrategy.DEFAULT_NAME;
import static com.example.score.core.ValueScoreStrategy.STRATEGY;
import static com.example.score.core.ValueSourceExp.toStr;
import static com.example.score.service.ScoreFeature.ConditionalTagExist;
import static com.example.score.service.ScoreTagConfigService.DEFAULT_VALUE_CREDIT_RECORD;
import static com.example.score.service.ScoreTagConfigService.DEFAULT_VALUE_SENTIMENT;
...
import static com.example.score.service.ScoreTreeLevel.TERTIARY_TAG;
import static com.example.score.service.ScoreTreeLevel.TREE_ROOT;
